\hypertarget{hints_autotoc_md17}{}\doxysubsection{Hints on input files.}\label{hints_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{hints_autotoc_md18}{}\doxysubsection{Hints on bonding definitions.}\label{hints_autotoc_md18}

\begin{DoxyItemize}
\item In C\+DE, bonds between atoms are based on a cutoff distance given by {\itshape R = (Cov\+Rad(i) + Cov\+Rad(j)) $\ast$ bondingsf}. The factors Cov\+Rad(\+:) are the covalent radii of each species, and can be found in {\itshape \mbox{\hyperlink{constants_8f90_source}{constants.\+f90}}}. The factor {\bfseries{bondingsf}} is also found in \mbox{\hyperlink{constants_8f90_source}{constants.\+f90}} -\/ it is a scale-\/factor, usually with a value of 1.\+1.
...
\end{DoxyItemize}\hypertarget{hints_autotoc_md19}{}\doxysubsection{Hints on external executables}\label{hints_autotoc_md19}
...
\end{DoxyItemize}\hypertarget{hints_autotoc_md20}{}\doxysubsection{Common problems}\label{hints_autotoc_md20}
