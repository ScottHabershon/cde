...
sh = 0 
for i in range(ndir):
  if os.path.exists("./path_fix_pt_" + str(i+1) + "/input_neb.energy-neb-end"):
#  if os.path.exists("./path_fix_pt_" + str(i+1) + "/input_neb.energy-autoneb-end"):
   dirs.append(i)
   filn.append("./path_fix_pt_" + str(i+1) + "/input_neb.energy-neb-end")
#   filn.append("./path_fix_pt_" + str(i+1) + "/input_neb.energy-autoneb-end")
   sh = 2
   continue
  if os.path.exists("./path_fix_pt_" + str(i+1) + "/input_neb.energy-neb-end"):
#  if os.path.exists("./path_fix_pt_" + str(i+1) + "/input_neb.energy-autoneb-end"):
